"""Init complete schema v2

Revision ID: 2aaeb739f625
Revises: 
Create Date: 2026-09-08 03:07:42.994689
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_claim_slas_tenant_id'), 'claim_slas', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_financial_ledgers_tenant_id'), 'financial_ledgers', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_system_activity_logs_tenant_id'), 'system_activity_logs', ['tenant_id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('tenant_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['assigned_adjuster_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['customer_id'], ['customers.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_system_activity_logs_tenant_id'), table_name='system_activity_logs')
    ...
    op.drop_index(op.f('ix_financial_ledgers_tenant_id'), table_name='financial_ledgers')
    op.drop_table('financial_ledgers')
    op.drop_index(op.f('ix_claim_slas_tenant_id'), table_name='claim_slas')
    op.drop_table('claim_slas')
    # ### end Alembic commands ###
